    ...
    <>
        ...
        <div className="partner-hero-content">
          ...
          <div className="partner-hero-actions">
            <Link to="/contact" className="btn-primary btn-large">
              Apply to Partner <i className="fas fa-arrow-right"></i>
            </Link>
      ...
      <section className="partner-tiers" id="tiers">
        ...
        <p className="partner-tiers-note">
          ...
          <Link to="/contact"> Contact us</Link> for detailed pricing.
        </p>
      </section>
      ...
      <section className="partner-cta">
        <div className="partner-cta-content">
          ...
          <div className="partner-cta-actions">
            ...
            <a href="mailto:partners@pathtoagility.com" className="btn-ghost">
              Email Us <i className="fas fa-envelope"></i>
            </a>
          </div>
        </div>
      </section>
