    ...
    <>
      ...
      <header className="page-hero problems-hero">
        ...
        <div className="page-hero-content">
          ...
          <p className="page-intro">These are the 8 problems that kill agile transformations. We've solved each one dozens of times.</p>
        </div>
      </header>
      ...
      <section className="problems-main">
        <div className="problems-grid-full">
          {problems.map(problem => (
            <Link key={problem.id} to={`/whats-in-your-way/${problem.slug}`} className={`problem-card-large ${problem.hot ? 'hot' : ''}`}>
        ...
        <div className="problems-stats-inner">
          ...
          <div className="problems-stats-grid">
            <div className="problems-stat">
              ...
              <span className="problems-stat-label">of agile transformations fail</span>
            </div>
            <div className="problems-stat">
