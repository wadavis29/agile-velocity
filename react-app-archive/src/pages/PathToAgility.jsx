...
const stages = [
  {
    name: 'Align',
    icon: 'fa-layer-group',
    description: 'Align the agile initiative with measurable business outcomes and define a clear transformation roadmap.'
  },
  {
    name: 'Learn',
    icon: 'fa-lightbulb',
    description: 'Establish foundational agile practices and a culture of learning by empowering teams to take ownership of their work and process.'
  },
  {
    name: 'Predict',
    icon: 'fa-chess',
  ...
  },
  {
    name: 'Adapt',
    icon: 'fa-globe',
    description: 'Embrace organization-wide agility in order to quickly respond to market demands.'
  }
];
...
const challenges = [
  {
    ...
    description: 'Focusing on implementing Agile ceremonies instead of achieving business results.'
  },
  {
    icon: 'fa-users',
    title: 'Team-Level Only',
    description: 'Limiting agility to individual teams without system or organizational change.'
  },
  {
...
const levels = [
  ...
  },
  {
    icon: 'fa-users',
    name: 'Team',
    description: 'Teams successfully take on new roles, establish agile team practices, increase employee engagement, and achieve a sustainable, predictable cadence of delivering value.'
  }
];
    ...
    <>
      ...
      <header className="p2a-hero-kinetic">
        ...
        <div className="p2a-hero-content">
          ...
          <div className="p2a-hero-actions">
            ...
            <Link to="/outcomes" className="btn-kinetic-ghost">
      ...
      <section className="p2a-challenges">
        <div className="section-header">
          ...
          <p className="section-subtitle">Organizations pursuing Agile often get stuck—teams adopt ceremonies but nothing changes, or agility exists in pockets while the rest of the org stays the same.</p>
        </div>
          ...
          <div className="cascade-flow">
            ...
            <div className="cascade-connector">
              <div className="connector-row">
                <span className="connector-text-top">"Why" Dictates Priorities</span>
            ...
            <div className="cascade-item">
              ...
              <div className="cascade-label">Agile Outcomes</div>
            ...
            <div className="cascade-item">
              ...
              <div className="cascade-label">Agile Practices</div>
      ...
      <section className="p2a-journey">
        <div className="section-header">
          ...
          <h2 className="section-title">Five Stages to <span className="highlight">Business Agility</span></h2>
        ...
        <div className="jcurve-wrapper">
          <svg className="jcurve-svg" viewBox="0 0 1000 300" preserveAspectRatio="none">
            <defs>
            ...
            <path
              d="M 0 80
                 C 100 85, 150 120, 250 180
                 C 350 250, 380 280, 450 285
                 C 520 290, 550 240, 650 120
                 C 750 20, 800 8, 900 5
                 C 950 3, 980 5, 1000 6"
              fill="none"
      ...
      <section className="p2a-levels-section">
        <div className="section-header">
          ...
          <p className="section-subtitle">True agility requires change across the entire organization—not just teams.</p>
        </div>
      ...
      <section className="problems-stats">
        <div className="problems-stats-inner">
          <div className="problems-stats-content">
            ...
            <p>Because doing agile isn't the same as being agile. Transformation success isn't about ceremonies—it's about results.</p>
          </div>
          <div className="problems-stats-grid">
            <div className="problems-stat">
              ...
              <span className="problems-stat-label">of Agile transformations fail to deliver expected results</span>
            </div>
            <div className="problems-stat">
      ...
      <aside className="navigator-aside" id="navigator">
        <div className="navigator-aside-inner">
          ...
          <div className="navigator-aside-actions">
            <Link to="/path-to-agility/navigator" className="btn-navigator">
              See How It Works <i className="fas fa-arrow-right"></i>
            </Link>
            <Link to="/request-a-trial" className="btn-navigator-ghost">
              Free Trial
            </Link>
          </div>
        </div>
      ...
      <section className="cta">
        ...
        <div className="cta-content">
          ...
          <Link to="/contact" className="btn-primary btn-large">Book a Call <i className="fas fa-arrow-right"></i></Link>
