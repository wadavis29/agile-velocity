...
import { getAllTeamMembers, getLeadership } from '../../data/team';
      ...
      <section className="about-mission">
        <div className="about-mission-inner">
          <div className="about-mission-content">
            ...
            <p>
              Too many agile transformations fail because they focus on practices instead of results.
        ...
        <div className="about-story-inner">
          ...
          <div className="about-story-content">
            ...
            <p>
              ...
              who saw a gap in how organizations approached agile transformation. Too many companies were
              implementing agile practices without connecting them to business outcomes—and then wondering
        ...
        <div className="about-leadership-inner">
          ...
          <div className="about-leadership-grid">
            {leadership.map((member) => (
              <Link key={member.id} to={`/about/team/${member.id}`} className="about-leader-card">
          ...
          <div className="about-leadership-cta">
            <Link to="/about/team" className="btn-primary">
              Meet the Full Team <i className="fas fa-arrow-right"></i>
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="about-recognition-inner">
          ...
          <div className="about-recognition-items">
            ...
            <div className="about-recognition-item">
              ...
              <span>Scaled Agile Partner</span>
      ...
      <section className="about-cta">
        <div className="about-cta-inner">
          ...
          <div className="about-cta-actions">
            ...
            <Link to="/path-to-agility" className="btn-ghost btn-lg">
