...
import { publicWorkshops, getCourseById, courseCategories } from '../../data/courses';
...
export default function PublicWorkshops() {
  ...
  const workshopsByMonth = filteredWorkshops.reduce((acc, workshop) => {
    const monthKey = new Date(workshop.date.start).toLocaleDateString('en-US', {
      month: 'long',
      year: 'numeric'
    });
      ...
      <section className="workshops-hero">
        <div className="workshops-hero-inner">
          ...
          <p className="workshops-hero-sub">
            Find the perfect Agile certification workshop for your role or industry.
            Join our expert-led virtual sessions and earn your credential.
          </p>
          <div className="workshops-hero-actions">
            <a href="#schedule" className="btn-primary">
              View Upcoming Workshops <i className="fas fa-arrow-down"></i>
            </a>
        ...
        <div className="workshops-schedule-inner">
          ...
          {Object.keys(workshopsByMonth).length > 0 ? (
                      ...
                      <div key={idx} className="workshop-item">
                        <div className="workshop-item-date">
                          <span className="workshop-item-day">
                            {new Date(workshop.date.start).getDate()}
                          </span>
                          <span className="workshop-item-month">
                            {new Date(workshop.date.start).toLocaleDateString('en-US', { month: 'short' })}
                          </span>
                        </div>
                        <div className="workshop-item-content">
                          ...
                          <div className="workshop-item-meta">
                            <span className="workshop-item-dates">
                              ...
                              {formatDateRange(workshop.date.start, workshop.date.end)}
                            </span>
            ...
            <div className="workshops-empty">
              ...
              <Link to="/training/for-organizations" className="btn-ghost">
                Explore Private Training <i className="fas fa-arrow-right"></i>
              </Link>
            </div>
          )}
        ...
        <div className="workshops-private-cta-inner">
          ...
          <div className="workshops-private-cta-actions">
            ...
            <Link to="/training/for-organizations" className="btn-primary">
              Get Private Training Quote <i className="fas fa-arrow-right"></i>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="workshops-cta">
        <div className="workshops-cta-inner">
          ...
          <a href="#schedule" className="btn-primary btn-lg">
            View Workshop Schedule <i className="fas fa-arrow-up"></i>
          </a>
        </div>
      </section>
    </>
