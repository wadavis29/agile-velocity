...
import { getCourseBySlug, getRelatedCourses, courseCategories, publicWorkshops, getCourseById } from '../../data/courses';
...
export default function CourseDetail() {
  ...
  if (!course) {
    return <Navigate to="/training/courses" replace />;
  }
      ...
      <section className="course-detail-hero">
        <div className="course-detail-hero-inner">
          <div className="course-detail-breadcrumb">
            ...
            <i className="fas fa-chevron-right"></i>
            <Link to={`/training/courses?category=${course.category}`}>{categoryInfo?.label}</Link>
          </div>
            ...
            <div className="course-detail-hero-main">
              ...
              <div className="course-detail-actions">
                <Link to="/contact" className="btn-primary btn-large">
                  Schedule Private Training <i className="fas fa-arrow-right"></i>
                </Link>
              ...
              {upcomingDates.map((date, idx) => (
                <div key={idx} className="course-date-card">
                  ...
                  <div className="course-date-action">
                    ...
                    <a
                      href={workshopData.eventbriteUrl}
                      target="_blank"
      ...
      <section className="course-detail-private">
        <div className="course-detail-private-inner">
          ...
          <div className="course-detail-private-action">
            <Link to="/contact" className="btn-primary btn-large">
              Get a Private Training Quote <i className="fas fa-arrow-right"></i>
            </Link>
          ...
          <div className="course-detail-related-inner">
            ...
            <div className="course-related-grid">
              {relatedCourses.map(related => (
                <Link key={related.id} to={`/training/courses/${related.slug}`} className="course-related-card">
