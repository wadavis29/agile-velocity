export const problems = [
    ...
    approach: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'Priorities change. That\'s fine. We create regular cadences to reassess and adjust, so changes happen in an orderly way instead of constant disruption.',
...

  {
    ...
    problem: {
      ...
      symptoms: [
        ...
        { icon: 'fa-code-merge', text: 'Integration is painful. Everyone\'s code conflicts' }
      ]
    },
...

  {
    ...
    benefit: {
      ...
      points: [
        ...
        'Fewer approval hoops, teams can actually move',
...

  {
    ...
    problem: {
      ...
      description: 'People are tired. Not normal tired, bone-deep, considering-quitting tired. They\'ve been through three reorgs, four strategy pivots, and two failed transformations. Now you\'re asking for another change and getting dead stares. Trust is gone. Nobody goes above and beyond anymore. Your best people are updating their resumes.',
      symptoms: [
      ...
      steps: [
        {
          ...
          description: 'We identify what\'s creating overload: too much WIP, unrealistic deadlines, understaffed teams. Then we reduce it. Not by working smarter, by doing less. Sustainable pace starts with sustainable expectations.',
