export const outcomes = [
  {
    ...
    title: 'Build Teams That Care',
    highlight: 'Care',
    icon: 'fa-users',
    iconPath: '/images/outcome-icons/employee-engagement.svg',
    ...
    signs: [
      { icon: 'fa-clock', text: 'People do exactly what\'s asked. Nothing more. No initiative, no suggestions, no extra effort.' },
...

  {
    ...
    icon: 'fa-heart',
    iconPath: '/images/outcome-icons/customer-satisfaction.svg',
...

  {
    ...
    iconPath: '/images/outcome-icons/quality.svg',
...

  {
    ...
    highlight: 'Faster',
    icon: 'fa-rocket',
    iconPath: '/images/outcome-icons/speed.svg',
    ...
    outcomes: {
      ...
      items: [
        ...
        },
        {
          ...
          proof: '"We reduced idea-to-development time from months to weeks." - Qualitrol, achieving 25% cycle time reduction through dedicated product squads'
        },
        {
...

  {
    ...
    iconPath: '/images/outcome-icons/predictability.svg',
      ...
      items: [
        {
          ...
          proof: '"Agile Velocity helped us move from siloed, perfection-first delivery to a predictable, value-driven approach." - Anis Zribi, VP of R&D, Qualitrol'
        },
        {
...

  {
    ...
    highlight: 'Reality',
    icon: 'fa-lightbulb',
    iconPath: '/images/outcome-icons/innovation.svg',
...

  {
    ...
    icon: 'fa-sync-alt',
    iconPath: '/images/outcome-icons/market-responsiveness.svg',
...

  {
    ...
    icon: 'fa-chart-line',
    iconPath: '/images/outcome-icons/productivity.svg',
    ...
    outcomes: {
      ...
      items: [
        ...
        },
        {
          ...
          proof: '"40% improvement in new product introduction investment utilization." - Qualitrol, through focused prioritization and value-driven delivery'
        }
      ]
    },
...

  {
    ...
    iconPath: '/images/outcome-icons/continuous-improvement.svg',
