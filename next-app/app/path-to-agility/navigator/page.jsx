...
import NavigatorDemoForm from '@/components/NavigatorDemoForm'
import StickyDemoCTA from '@/components/StickyDemoCTA'

export const metadata = {
  title: 'Navigator Software',
  description: 'Path to Agility Navigator: Assess your teams against 100 capabilities, visualize progress with heatmaps, and get prioritized action items tied to business outcomes.',
  openGraph: {
    title: 'Path to Agility Navigator | Agile Velocity',
    description: 'The Path to Agility framework, in software. Assess, analyze, prioritize, plan, and act.',
  },
}
  ...
  return (
    <>
      ...
      <header className="navigator-hero">
        ...
        <div className="navigator-hero-content">
          ...
          <div className="navigator-hero-actions">
            <a href="#get-demo" className="btn-primary btn-large">
              Get Your Demo
            </a>
            <Link href="/path-to-agility/navigator/plans" className="btn-ghost">
              View Plans <i className="fas fa-tags"></i>
            </Link>
          </div>
        </div>
        ...
        <div className="navigator-framework-note-inner">
          ...
          <div className="navigator-framework-note-content">
            ...
            <p>
              ...
              <Link href="/path-to-agility"> Learn about the methodology <i className="fas fa-arrow-right"></i></Link>
            </p>
          </div>
        </div>
      </section>
            ...
            <div key={item.id} className={`navigator-showcase-item ${index % 2 === 1 ? 'reverse' : ''}`}>
              <div className="navigator-showcase-image">
                {item.image.includes('placeholder') ? (
                  ...
                  <Image src={item.image} alt={item.title} width={600} height={400} loading="lazy" unoptimized />
                )}
              </div>
      ...
      <section className="navigator-benefits">
        <div className="navigator-benefits-inner">
          <div className="navigator-benefits-content">
            ...
            <div className="navigator-benefits-actions">
              <a href="#get-demo" className="btn-primary">
                Get Your Demo
              </a>
              <Link href="/path-to-agility/navigator/plans" className="btn-text">
                View Plans
              </Link>
            </div>
          </div>
      ...
      <section className="navigator-use-cases">
        ...
        <div className="navigator-use-cases-cta">
          <Link href="/path-to-agility/navigator/plans" className="btn-ghost">
            <i className="fas fa-tags"></i> Compare Plans & Features
          </Link>
        </div>
      </section>
      ...
      <section className="navigator-audience">
        ...
        <div className="navigator-audience-grid">
          <div className="navigator-audience-card">
            ...
            <p>Real-time visibility into progress across all teams. Generate stakeholder reports in seconds, not days. Finally answer &ldquo;how&apos;s the transformation going?&rdquo; with data.</p>
          </div>
          <div className="navigator-audience-card">
      ...
      <section className="navigator-faq">
        ...
        <div className="navigator-faq-cta">
          <Link href="/path-to-agility/navigator/plans" className="btn-ghost">
      ...
      {/* Embedded Demo Form - Bottom of Page */}
      <NavigatorDemoForm />
    </>
  )
}
