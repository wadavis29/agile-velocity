...
import { CaseStudyCallout, getCaseStudiesForProblem } from '@/components/CaseStudyCallout'
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: problem.title,
    description: problem.shortDesc || problem.problem.description.split('.').slice(0, 2).join('.') + '.',
    openGraph: {
      title: `${problem.title} | Agile Velocity`,
...
export default async function ProblemDetail({ params }) {
  ...
  const relatedCaseStudies = getCaseStudiesForProblem(problem.slug)
  ...
  return (
    <>
      ...
      {relatedCaseStudies.length > 0 && (
        <section className="problem-section case-studies-section">
          <div className="problem-section-inner">
            <span className="section-tag">We&apos;ve Solved This Before</span>
            <h2>See How We <span className="highlight">Fixed It</span></h2>
            <p className="section-intro">Real organizations that overcame this challenge with our help.</p>
            <div className="problem-case-studies-grid">
      ...
      <section className="cta">
        ...
        <div className="cta-content">
          ...
          <Link href="/contact" className="btn-primary btn-large">
            {problem.cta.buttonText || 'Let\'s Talk'}
          </Link>
        </div>
      </section>
        ...
        <div className="related-problems-inner">
          ...
          <div className="related-grid">
            {relatedProblems.map(related => (
              <Link key={related.id} href={`/whats-in-your-way/${related.slug}`} className="problem-card-related">
