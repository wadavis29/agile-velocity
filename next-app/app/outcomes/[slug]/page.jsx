...
import { CaseStudyCallout, getCaseStudiesForOutcome } from '@/components/CaseStudyCallout'
import OutcomeProgressNav from '@/components/OutcomeProgressNav'
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      title: `${outcome.title} | Agile Velocity`,
      description: outcome.lead || outcome.description,
    },
  }
}

export default async function OutcomeDetail({ params }) {
  const { slug } = await params
  const outcome = getOutcomeBySlug(slug)
  ...
  const relatedCaseStudies = getCaseStudiesForOutcome(outcome.slug)
  ...
  return (
    <>
      ...
      <header className="outcome-hero-bold" id="hero">
      ...
      <section className="outcome-section problem-section" id="problem-section">
      ...
      <section className="outcome-section signs-section" id="signs-section">
        <div className="outcome-section-inner">
      ...
      <section className="outcome-section outcomes-section" id="outcomes-section">
        <div className="outcome-section-inner">
      ...
      {relatedCaseStudies.length > 0 && (
        <section className="outcome-section case-studies-section" id="case-studies-section">
          <div className="outcome-section-inner">
            <span className="section-tag">See It In Action</span>
            <h2>Real <span className="highlight">Results</span></h2>
            <p className="section-intro">Organizations that achieved this outcome with our help.</p>
            <div className="outcome-case-studies-grid">
              {relatedCaseStudies.slice(0, 2).map(study => (
                <CaseStudyCallout key={study.id} study={study} />
              ))}
            </div>
          </div>
        </section>
