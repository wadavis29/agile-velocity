...
export const metadata = {
  title: 'Private Corporate Training | Agile Velocity',
  description: 'Private Agile training for your team. Customized content, flexible scheduling, and same certifications as public workshops.',
}
      ...
      <section className="corporate-hero">
        <div className="corporate-hero-inner">
          ...
          <p className="corporate-hero-sub">
            More than training, it&apos;s an experience. Your team works together on real projects,
            tackles actual challenges, and leaves with solutions they can apply the next day.
          </p>
        ...
        <div className="corporate-benefits-inner">
          ...
          <div className="corporate-benefits-grid">
            ...
            <div className="corporate-benefit">
              ...
              <h3>Bring Your Real Work</h3>
              <p>Participants work on actual projects and current challenges during the workshop, not hypothetical scenarios.</p>
            </div>
            <div className="corporate-benefit">
            ...
            <div className="corporate-benefit">
              ...
              <h3>Leave With Solutions</h3>
              <p>Participants don&apos;t just learn concepts. They leave with real applications to current issues they can implement the next day.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="corporate-what-we-teach">
        <div className="corporate-what-we-teach-inner">
          ...
          <div className="corporate-course-categories">
            <Link href="/training/courses?category=scrum" className="corporate-category-link">
              <i className="fas fa-sync-alt"></i>
              <span>Scrum & Agile Fundamentals</span>
            </Link>
            <Link href="/training/courses?category=safe" className="corporate-category-link">
              <i className="fas fa-sitemap"></i>
              <span>SAFe (Scaled Agile)</span>
            </Link>
            <Link href="/training/courses?category=leadership" className="corporate-category-link">
              <i className="fas fa-chess-king"></i>
              <span>Leadership & Management</span>
            </Link>
            <Link href="/training/courses?category=kanban" className="corporate-category-link">
              <i className="fas fa-columns"></i>
              <span>Kanban & Flow</span>
            </Link>
            <Link href="/training/courses?category=specialized" className="corporate-category-link">
