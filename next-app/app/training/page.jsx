...
export const metadata = {
  title: 'Agile Training & Certification | Agile Velocity',
  description: '30+ courses across Scrum, SAFe, Leadership, and Kanban. Hands-on training led by practitioners who\'ve done it, not just taught it.',
}
      ...
      <section className="training-hero">
        <div className="training-hero-inner">
          ...
          <p className="training-hero-sub">
            30+ courses across Scrum, SAFe, Leadership, and Kanban. These aren&apos;t lectures. They&apos;re
            hands-on workshops led by practitioners who&apos;ve done it, not just taught it. You&apos;ll
            practice, collaborate, and leave with skills you can apply immediately.
          </p>
        ...
        <div className="training-categories-inner">
          ...
          <div className="training-categories-grid">
            {courseCategories.map(cat => (
              <Link key={cat.id} href={`/training/courses?category=${cat.id}`} className="training-category-card">
        ...
        <div className="training-featured-inner">
          ...
          <div className="training-featured-grid">
            {featuredCourses.slice(0, 6).map(course => (
              <Link key={course.id} href={`/training/courses/${course.slug}`} className="training-course-card">
        ...
        <div className="training-why-inner">
          ...
          <div className="training-why-grid">
            ...
            <div className="training-why-card">
              ...
              <h3>Workshops, Not Lectures</h3>
              <p>Interactive exercises and real collaboration, not death by PowerPoint. You&apos;ll practice what you learn and leave ready to apply it.</p>
            </div>
            <div className="training-why-card">
              <div className="training-why-icon">
          ...
          <div className="training-upcoming-inner">
            ...
            <div className="training-upcoming-grid">
              {upcomingWorkshops.map((workshop, idx) => (
                <Link key={idx} href={`/training/courses/${workshop.course?.slug}`} className="training-workshop-card">
      ...
      <section className="training-private-highlight">
        <div className="training-private-highlight-inner">
          <div className="training-private-highlight-content">
            ...
            <p>
              Private training for teams of 8+ is more than a course. It&apos;s an experience.
              Participants bring real work, tackle actual challenges, and leave with solutions they can apply immediately.
            </p>
            <ul>
              <li><i className="fas fa-check"></i> Work on your actual projects during the workshop</li>
              <li><i className="fas fa-check"></i> Leave with real applications to current issues</li>
